    ...
    if (window.location.href == SiteIndexUrl) {      // 如果是主页
        ...
        if(document.referrer !== ''){
            ...
            if (window.location.hostname == referrer.hostname) {
                text = '欢迎阅读spaserby哥哥的<span style="color:#0099cc;">『' + document.title.split(' - ')[0] + '』</span>';
...
function showHitokoto(){
    $.getJSON('//api.fghrsh.net/hitokoto/rand/?encode=jsc&uid=3335',function(result){
        var text = '这句一言出处是 <span style="color:#0099cc;">『{source}』</span>，是 <span style="color:#0099cc;">灵儿</span> 在 {date} 收藏的！';
...
var waifuJson = {
    ...
    "click": [
        {
            "selector": ".waifu #live2d",
            "text": ["是…是不小心碰到了吧", "萝莉控是什么呀", "不要用鼠标一直点我！！", "再摸的话我可要报警了！⌇●﹏●⌇", "110吗，这里有个变态一直在摸我(ó﹏ò｡)"]
        }
    ],
    "seasons": [
        {
